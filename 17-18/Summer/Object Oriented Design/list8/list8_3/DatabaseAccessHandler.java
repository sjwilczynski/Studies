...
public class DatabaseAccessHandler implements DataAccessStrategy {
    ...
    @Override
    public void getData() throws ConnectionException {
        try {
...
class XMLAccessHandler implements DataAccessStrategy {
    private String path;
