% Wersja z 10 pa�dziernika 2014 r.
\documentclass[11pt,wide]{mwart}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Styl dokumentu   : 'mwart'.
% Rozmiar czcionki : '11pt' (domy�lnie '10pt', mo�na u�ywa� tak�e czcionki '12pt').
% Numeracja wzor�w : po lewej stronie - 'leqno'.
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Środowisko do pisania twierdzeń.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% maszynow�, i �e - co najwa�niejsze - w obrebie +...+ nie bed� uwzgl�dniane
% komendy LaTeXa.
%
% '\noindent' - bez akapitu.
%
...
Mo�na robi� przypisy\footnote{To jest przypis.}.\\[3ex] % <-- Takie co� robi
{\tiny test} (\verb+{\tiny ...}+)\\                     % odst�p wielko�ci 3ex,
{\scriptsize test} (\verb+{\scriptsize ...}+)\\         % czyli trzech wysoko�ci
...
\begin{enumerate}
\itemsep 3pt% ustawia odst�p pomi�dzy podpunktami
...
%%%%%%%%%%%%%%%%%%%%
\renewcommand{\arraystretch}{1.5}  % Zwi�kszamy wielkos� kom�rki (o 1.5 raza).
%%%%%%%%%%%%%%%%%%%%
\begin{center}
\begin{tabular}{||c||c|c|c||} \hline
\multicolumn{4}{||c||}{Funkcja $f(x)=\arctan x$} \\ \hline
...
\end{center}
%%%%%%%%%%%%%%%%%%%%
\renewcommand{\arraystretch}{1}  % Powracamy do ustawie� standardowych.
%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Znowu modyfikujemy warto�� '\arraystretch', kt�ra okre�la odst�p mi�dzy
% wierszami.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibitem{LL} L. Lamport, \LaTeX -- System przygotowywania dokument�w,
             Ariel, Krak�w 1992.
...
\bibitem{II} \url{http://www.ii.uni.wroc.pl}   (ostatni dost�p do strony 2014-09-23).
